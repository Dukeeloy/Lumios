...
const firebaseConfig = {
  ...
  databaseURL: "https://controle-de-presenca2-default-rtdb.firebaseio.com",
  projectId: "controle-de-presenca2",
  storageBucket: "controle-de-presenca2.firebasestorage.app",
  messagingSenderId: "672980279679",
  appId: "1:672980279679:web:8a554229140b669be4ba4a"
};
...
const comandoResetarRef = ref(db, "sala/comando/resetar");
const comandoLigarRef = ref(db, "sala/comando/ligarLuz");

onValue(pessoasRef, (snapshot) => {
  document.getElementById("contador").innerText = snapshot.val() ?? 0;
});
